...
ngApp.controller('ControllerInmueble', function ($scope, $http) {
    ...
    $scope.createTodo = function () {
        $http
        .post("http://localhost:3000/inmueble", $scope.formData)
    ...
    $scope.ListTodo = function () {
        $http
        .get("http://localhost:3000/inmueble", $scope.formData)
        .then(function successCallback(response){
            // $scope.formData = {};
